...
class DrawRectangle(AbstractShape):
    ...
    def draw(self, **kwargs):
        ...
        if self.cRectangle == 0:
            ...
            cv2.rectangle(new_image, (int(k2x[0]) + 10, int(k2n[1]) - 10), (int(k2n[0]) - 10, int(k2x[1]) + 10), self.color, 2)
            cv2.rectangle(new_image, (int(k1x[0]) + 10, int(k1n[1]) - 10), (int(k1n[0]) - 10, int(k1x[1]) + 10), self.color, 2)
