...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Region-level forgery detection with LLM + GroundingDINO + SAM2"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to FFD mask directory (used for copy-move)"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to region prompt images"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Output directory for final segmentation results"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="gpt-5-chat",
        help="LLM model name (e.g., gpt-5-chat, gemini-2.5-pro-preview-03-25)"
    )

    parser.add_argument(
        "--use_ffd_mask",
        action="store_true",
        help="Use FFD mask for copy-move cases"
    )
    ...
    detection(
        ...
        ffd_mask_path=args.ffd_mask_path,
        region_prompt_path=args.region_prompt_path,
        out_path=args.out_path,
        doc_type=args.doc_type,
        llm_model=args.llm_model,
        use_ffd_mask=args.use_ffd_mask
    )
